...
def get_unique_donors():
    """
    Extracts a list of unique donor names from all the donations.
    ...
    # Loop to collect unique names without using 'set'
...
def get_donor_summary():
    ...
    Returns:
        dict: A dictionary where keys are donor names and values 
